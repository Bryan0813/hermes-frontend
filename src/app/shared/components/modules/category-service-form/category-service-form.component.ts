...
export class CategoryServiceFormComponent {
  @Input() categoryService: CategoryServiceModel = new CategoryServiceModel(); // Recibe la catregoria desde el componente padre
  @Output() onSave = new EventEmitter<CategoryServiceModel>(); // Emite el evento al guardar
